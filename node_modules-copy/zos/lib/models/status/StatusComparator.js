...
const StatusReport_1 = __importDefault(require("./StatusReport"));
const log = new zos_lib_1.Logger('StatusComparator');
class StatusComparator {
    ...
    _addReport(expected, observed, description) {
        const report = new StatusReport_1.default(expected, observed, description);
        this.reports.push(report);
    }
}
exports.default = StatusComparator;
//# sourceMappingURL=StatusComparator.js.map