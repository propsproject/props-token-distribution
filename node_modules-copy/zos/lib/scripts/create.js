...
function createProxy({ packageName, contractAlias, initMethod, initArgs, network, txParams = {}, force = false, networkFile }) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            const proxy = yield controller.createProxy(packageName, contractAlias, initMethod, initArgs);
